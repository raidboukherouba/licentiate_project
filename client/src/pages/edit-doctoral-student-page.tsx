...
import { fetchDoctoralStudentById, updateDoctoralStudent } from '../services/doctoralStudentService';
...
export default function EditDoctoralStudentPage() {
      ...
      try {
        ...
        if (regNum) {
          ...
          if ('doctoralStudent' in response) {
            const doctoralStudent = response.doctoralStudent;
            form.reset({
              reg_num: Number(doctoralStudent.reg_num),
              doc_stud_fname: doctoralStudent.doc_stud_fname,
              doc_stud_lname: doctoralStudent.doc_stud_lname,
              doc_stud_fname_ar: doctoralStudent.doc_stud_fname_ar,
              doc_stud_lname_ar: doctoralStudent.doc_stud_lname_ar,
              doc_stud_gender: doctoralStudent.doc_stud_gender,
              doc_stud_prof_email: doctoralStudent.doc_stud_prof_email,
              func_code: doctoralStudent.func_code,
              spec_code: doctoralStudent.spec_code,
              team_id: doctoralStudent.team_id,
              lab_code: doctoralStudent.lab_code,
              doc_stud_attach_struc: doctoralStudent.doc_stud_attach_struc || "",
              doc_stud_birth_date: doctoralStudent.doc_stud_birth_date || null,
              doc_stud_phone: doctoralStudent.doc_stud_phone || "",
              doc_stud_address: doctoralStudent.doc_stud_address || "",
              doc_stud_grade: doctoralStudent.doc_stud_grade || "",
              doc_stud_diploma: doctoralStudent.doc_stud_diploma || "",
              doc_stud_pers_email: doctoralStudent.doc_stud_pers_email || "",
              doc_stud_gs_link: doctoralStudent.doc_stud_gs_link || "",
              doc_stud_rg_link: doctoralStudent.doc_stud_rg_link || "",
              doc_stud_page_link: doctoralStudent.doc_stud_page_link || "",
              doc_stud_orcid: doctoralStudent.doc_stud_orcid || "",
              doc_stud_pub_count: doctoralStudent.doc_stud_pub_count || 0,
              doc_stud_cit_count: doctoralStudent.doc_stud_cit_count || 0,
            });
          }
        }
      } catch (error: any) {
  ...
  const handleEdit = async (values: z.infer<typeof doctoralStudentSchema>) => {
    if (!regNum) return;

    try {
      const response = await updateDoctoralStudent(
        Number(regNum),
  ...
  return (
    <div className="container mx-auto px-4">
      <h1 className="text-2xl font-bold mb-4">{t("doctoralStudent.edit_title")}</h1>
      <Form {...form}>
