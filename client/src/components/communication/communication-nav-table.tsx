...
import { exportCommunications } from '@/services/communicationService';
...
interface CommunicationNavTableProps {
  searchQuery: string;
...
export default function CommunicationNavTable({
  searchQuery,
  setSearchQuery,
  itemsPerPage,
  setItemsPerPage,
  ...
  // Handle Export Function
    const handleExport = async () => {
      try {
        const blob = await exportCommunications();
        const url = window.URL.createObjectURL(blob);
        const a = document.createElement("a");
        a.href = url;
        a.download = "communications.xlsx"; // File name
  ...
  const navigateToAddCommunicationPage = () => {
    navigate('/research-productions/communications/add-communication');
  };
      ...
      <div className="w-full">
        <div className="flex flex-col gap-2 md:flex-row md:justify-between md:items-center mb-4">
          ...
          <div className="flex flex-col gap-2 md:flex-row md:items-center">
            ...
            {/* Export Communication button Button */}
            <Button
                variant="outline"
                size="sm"
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={navigateToAddCommunicationPage}
