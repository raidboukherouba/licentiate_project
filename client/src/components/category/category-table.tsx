...
export default function CategoryTable({ categories, currentPage, itemsPerPage, openEditModal, openDeleteModal, toggleSort }: CategoryTableProps) {
      ...
      <Table>
        <TableHeader className="bg-muted/50">
          <TableRow>
            ...
            <TableHead className="flex items-center gap-2 cursor-pointer" onClick={() => toggleSort('cat_name')}>
