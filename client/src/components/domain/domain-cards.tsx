...
export default function DomainCards({ domains, currentPage, itemsPerPage, openEditModal, openDeleteModal }: DomainCardProps) {
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      {domains.map((domain, index) => (
        <Card key={domain.domain_id} className="hover:shadow-lg transition-shadow">
          ...
          {/* <CardContent>
            <p>Additional details about the domain can go here.</p>
          </CardContent> */}
