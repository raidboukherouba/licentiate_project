...
import { exportEquipment } from "@/services/equipmentService";
...
interface EquipmentNavTableProps {
  searchQuery: string;
...
export default function EquipmentNavTable({
  searchQuery,
  setSearchQuery,
  itemsPerPage,
  setItemsPerPage,
  ...
  const navigateToAddEquipmentPage = () => {
    navigate('/equipment-management/equipment-inventory/add-equipment');
  };
