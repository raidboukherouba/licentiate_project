...
import { exportAssignResearchers } from "@/services/assignResearcherService";
...
interface AssignResearcherNavTableProps {
  searchQuery: string;
...
export default function AssignResearcherNavTable({
  searchQuery,
  setSearchQuery,
  itemsPerPage,
  setItemsPerPage,
  ...
  const handleExport = async () => {
    try {
      const blob = await exportAssignResearchers(searchQuery, selectedLab || undefined);
  ...
  // Navigate to the Add AssignResearcher page
  const navigateToAddAssignResearcherPage = () => {
    navigate('/equipment-management/assign-researcher/add-assignment');
  };
      ...
      <div className="w-full">
        <div className="flex flex-col gap-2 md:flex-row md:justify-between md:items-center mb-4">
          ...
          <div className="relative w-full md:w-70">
            ...
            <Input
              type="text"
              placeholder={t("assignResearcher.search_placeholder")}
              value={searchQuery}
              onChange={(e) => {
          ...
          <div className="flex flex-col gap-2 md:flex-row md:items-center">
            ...
            {/* Add AssignResearcher Button */}
            <Button
              variant="outline"
              size="sm"
              onClick={navigateToAddAssignResearcherPage}
